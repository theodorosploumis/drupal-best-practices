...
Claude skills for Drupal 10+ best practices now live in dedicated folders under `ai/skills/`, following Anthropics' recommended SKILL structure.
...
- `config-parser/` – Configuration parser for YAML validation
